    ...
    if query.data.startswith("file"):
        ...
        for file in files:
            ...
            if result.deleted_count:
                logger.info('PʀᴇDVD Fɪʟᴇ Fᴏᴜɴᴅ ! Sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴅᴀᴛᴀʙᴀsᴇ.')
            deleted+=1
        deleted = str(deleted)
        ...
        for file in files:
            ...
            if result.deleted_count:
                logger.info('CᴀᴍRɪᴘ Fɪʟᴇ Fᴏᴜɴᴅ ! Sᴜᴄᴄᴇssғᴜʟʟʏ ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴅᴀᴛᴀʙᴀsᴇ.')
            deleted+=1
        deleted = str(deleted)
